import { physicalStates } from '../../config/presets.js';

/**
 * Physical States Component
 * Maneja la renderización y lógica de los botones de "Estados Físicos".
 */
export class PhysicalStatesComponent {
    constructor(kernel) {
        this.kernel = kernel;
        this.states = physicalStates || {};
    ...
    applyState(state) {
        ...
        window.dispatchEvent(new CustomEvent('request-close-mobile-menu', { detail: { menu: 'physical' } }));
